 ...
 *   미중계     — 에레디비지에, 덴마크 슈퍼리가, 쉬페르리그, 세르비아·스코틀랜드·
  ...
  양민혁: [
    {
      ...
      type: 'ott',
      title: '쿠팡플레이 EFL 챔피언십 생중계',
      description: '양민혁의 포츠머스 전 경기 생중계. 챔피언십 국내 독점 스트리밍.',
      imageUrl: '',
      ctaText: '지금 시청하기',
      ctaUrl: 'https://www.coupangplay.com/sports',
      tag: 'OTT 중계',
    },
    {
      id: 'ad-양민혁-shop',
      type: 'merchandise',
      title: '포츠머스 공식 온라인 스토어',
      description: '양민혁 마킹 포츠머스 정품 유니폼 및 공식 굿즈.',
      imageUrl: '',
      ctaText: '공식 스토어 바로가기',
      ctaUrl: 'https://www.portsmouthfc.co.uk/shop',
      tag: '공식 스토어',
    },
  ],
  ...
  홍현석: [
    {
      ...
      type: 'ott',
      title: '쿠팡플레이 Ligue 1 생중계',
      description: '홍현석의 낭트 전 경기 생중계. 국내 유일 리그앙 독점 스트리밍.',
      imageUrl: '',
      ctaText: '지금 시청하기',
      ctaUrl: 'https://www.coupangplay.com/sports',
      tag: 'OTT 중계',
    },
    {
      id: 'ad-홍현석-shop',
      type: 'merchandise',
      title: 'FC 낭트 공식 온라인 스토어',
      description: '홍현석 마킹 낭트 정품 유니폼 및 공식 굿즈.',
      imageUrl: '',
      ctaText: '공식 스토어 바로가기',
      ctaUrl: 'https://boutique.fcnantes.com',
      tag: '공식 스토어',
    },
  ],
  ...
  권혁규: [
    {
      ...
      type: 'ott',
      title: '쿠팡플레이 Ligue 1 생중계',
      description: '권혁규의 낭트 전 경기 생중계. 국내 유일 리그앙 독점 스트리밍.',
      imageUrl: '',
      ctaText: '지금 시청하기',
      ctaUrl: 'https://www.coupangplay.com/sports',
      tag: 'OTT 중계',
    },
    {
      ...
      type: 'merchandise',
      title: 'FC 낭트 공식 온라인 스토어',
      description: '권혁규 마킹 낭트 정품 유니폼 및 공식 굿즈.',
      imageUrl: '',
      ctaText: '공식 스토어 바로가기',
      ctaUrl: 'https://boutique.fcnantes.com',
      tag: '공식 스토어',
  ...
  오현규: [
    {
      id: 'ad-오현규-shop',
      type: 'merchandise',
      title: 'KRC 겐크 공식 온라인 스토어',
      description: '오현규 마킹 KRC 겐크 정품 유니폼 및 공식 굿즈.',
      imageUrl: '',
      ctaText: '공식 스토어 바로가기',
      ctaUrl: 'https://shop.krc-genk.be',
      tag: '공식 스토어',
    },
  ],
  ...
  윤도영: [
    {
      id: 'ad-윤도영-shop',
      type: 'merchandise',
      title: 'SBV 엑셀시어 공식 온라인 스토어',
      description: '윤도영 마킹 엑셀시어 정품 유니폼 및 공식 굿즈.',
      imageUrl: '',
      ctaText: '공식 스토어 바로가기',
      ctaUrl: 'https://www.sbvexcelsior.nl/fanshop',
      tag: '공식 스토어',
    },
  ],
